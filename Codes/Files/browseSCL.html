<?php
	...
	$cat="SELECT * FROM tbl_artworks WHERE Category='Sculpture'";
...
<div id="content">
							<?php
							 ...
							 while($catres = $catrec->fetch(PDO::FETCH_BOTH)){
							 	...
							 	echo "<tr>";
							 	echo '<td colspan="2">'.'<a href="browseSCL.php?postID='.$catres['postID'].'"  >'.'<img src="'.$catres['Image'].'" width="200" height="150">'.'</a>'.'</td>';
							 	echo "</tr>";
							 	echo "<tr>";
