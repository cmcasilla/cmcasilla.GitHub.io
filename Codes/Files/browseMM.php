<?php
	...
	$cat="SELECT * FROM tbl_artworks WHERE Category='Mixed Media'";
...
<!DOCTYPE html>
	...
	<!--Head Section-->
		<head>
			...
			<link rel="icon" href="Codes/Styles/logo12.png
" sizes="32by32">
		...
		<body>
			<div id="page_wrapper">
				<div id="header_wrapper">
					<div id="header">
						<div id="logo">
							<img src="Codes/Styles/logo12.png
" height="50px" width="50px" alt="Inside Art">
								<span class="toleft">
								<h2 style="font-family:AR Destine;color:#000000;">In[ART]sidE</h2>
<p style="font-family:Rockwell;">The Newest Online Art Gallery and Community</p>

								</span>
								
<span class="date" style="font-size:8pt;position:absolute;top:30px; left:1075px;font-family:verdana;">
...
<div id="content">
							<?php
							 ...
							 while($catres = $catrec->fetch(PDO::FETCH_BOTH)){
							 	...
							 	echo "<tr>";
							 	echo '<td colspan="2">'.'<a href="browseMM.php?postID='.$catres['postID'].'"  >'.'<img src="'.$catres['Image'].'" width="200" height="150">'.'</a>'.'</td>';
							 	echo "</tr>";
							 	echo "<tr>";
						...
						while($datas = $resultsl->fetch(PDO::FETCH_BOTH)){
							...
							echo '<td>'.$desc.' '.$cat.'</td>';
							echo '</tr>';
							echo '<div id="comments_section" style="overflow:hidden;overlay-y:scroll;display:block;height:200px;width:500px;margin-left:20px">';
